...
class FormRule extends JsonFormBuilderCore {
    ...
    public function setCondition($value) {
        if (empty($value)) {
            JsonFormBuilder::throwError('Condition empty.');
        } else {
    ...
    public function getCustomRuleName() {
        return $this->_customRuleName;
    }

    public function setCustomRuleName($value) {
        $this->_customRuleName = $value;
    }

    private $_customRuleParam;

    public function getCustomRuleParam() {
        return $this->_customRuleParam;
    }

    public function setCustomRuleParam($value) {
        $this->_customRuleParam = $value;
    }

    private $_customRuleValidateFunction;

    public function getCustomRuleValidateFunction() {
        return $this->_customRuleValidateFunction;
    }

    public function setCustomRuleValidateFunction($value) {
        $this->_customRuleValidateFunction = $value;
    }
