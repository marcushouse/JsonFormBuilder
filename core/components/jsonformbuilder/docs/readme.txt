...
Over time FormItBuilder will be removed.

========================
What is JsonFormBuilder?
========================
JsonFormBuilder is a small framework to assist in quick development of forms and emails. Using a snippet (with some basic PHP commands). a complex form can be built much faster and can automatically use the jQuery plugin "Validation" methods.
http://bassistance.de/jquery-plugins/jquery-plugin-validation/

JsonFormBuilder's main purpose is to simplify form creation with a simple JSON structure mixed with any custom validation methods in PHP.
